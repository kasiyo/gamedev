...
void CGame::RenderMainMenu() {
    ...
    // Draw menu background and options
    ...
    /* or (const Button & button : m_MainMenuButtons) {
        button.Render(m_pRenderer);
...
void CGame::HandleMenuClick(const std::vector<Button>& buttons) {
...
void CGame::RenderPauseMenu() {// Render the pause menu
    m_pRenderer->BeginFrame();
...
void CGame::KeyboardHandler() {
    ...
    if (m_eGameState == eGameState::MainMenu && m_pKeyboard->TriggerDown(VK_RETURN)) {
